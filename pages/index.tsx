    ...
    <Layout>
      <article className="max-w-2xl">
        <header className="flex items-center">
          ...
          <div className="ml-4">
            <h1 className="text-l font-medium dark:text-slate-50">
              Jakub Krehel
            </h1>
            <h2 className="font-medium dark:text-gray-500">Product designer</h2>
          </div>
        </header>
        ...
        <footer className="mt-20">
          <span className="dark:text-slate-100">Connect</span>
          <ul className="mt-2 flex flex-wrap gap-4">
            {connections.map((connection) => (
              <li key={connection.label} className="dark:text-slate-100 ">
